...
export default function App() {
  ...
  // Inicialização neutra com nota 3 (Intermediário) para todas as 10 competências
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 sm:p-8 shadow-sm space-y-6">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 pb-4 border-b border-slate-200 dark:border-slate-800">
              ...
              <div className="flex items-center gap-2 w-full sm:w-auto">
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 17.25v3.375c0 .621-.504 1.125-1.125 1.125h-9.75a1.125 1.125 0 01-1.125-1.125V7.875c0-.621.504-1.125 1.125-1.125H5.4M7 8.25h12.75c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125H9.75a1.125 1.125 0 01-1.125-1.125V18M7.375 21h.75m-.75-3h.75m-.75-5h.75m-.75-5h.75M21 3v2.25C21 5.621 20.621 6 20.25 6H18m0 0V3.75C18 3.129 17.504 2.625 16.875 2.625h-9.75A1.125 1.125 0 006 3.75V6M18 6h-1.125m-1.125-3H8.25" />
                  </svg>
                  Copiar Markdown
                </button>
                <button
